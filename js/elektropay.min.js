...
function() {
    ...
    var e,
        ...
        n,
        i;
    return isMobile || 1 !== $(".exit-modal").length || Cookies("everpayLastLoginAccount") ? void 0 : (null != window.ab_tests ? (i = ["no-thanks", "busy", "original"], e = ab_tests.get_ab_test("exit-popup", [.333, .333, .334]), $(".exit-modal").addClass(i[ab_tests.char_to_index(e)])) : $(".exit-modal").addClass("original"), n = ouibounce($(".exit-modal")[0], {
        timer: 8e3,
        aggressive: !1,
        sensitivity: 5,
        delay: 200,
    ...
    $(".piropay_signup_form input").on("keydown", function() {
        var e;
        return e = $(this).parents(".elektropay_signup_form"), e.removeClass("error"), remove_signup_tooltips()
    }), $(document).on("submit", ".elektropay_query_form", null, function(e) {
        var t,
            n,
            i;
    ...
    }), $(document).on("submit", ".elektropay_signup_form:not(.elektropay_query_form)", null, function(e) {
        var t,
            n,
            i,
            r,
